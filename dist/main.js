...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _factories_shipFactory_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./factories/shipFactory.js */ \"./src/factories/shipFactory.js\");\n/* harmony import */ var _factories_boardFactory_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./factories/boardFactory.js */ \"./src/factories/boardFactory.js\");\n/* harmony import */ var _factories_playerFactory_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./factories/playerFactory.js */ \"./src/factories/playerFactory.js\");\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n\n\n\n\n\n\n\n\nconst boardUI = function(ref, appendTo){\n    let container = document.getElementById(appendTo)\n    for (let i=0; i<10; i++){\n        for (let j=0; j<10; j++){\n        let grid = document.createElement('div')\n        grid.setAttribute('id', `${ref}-${i}-${j}`)\n        grid.setAttribute('data-x', `[${i}]`)\n        grid.setAttribute('data-y', `[${j}]`)\n        grid.setAttribute('class', `board-grid`)\n        container.appendChild(grid)\n        }\n    }\n\n    return container\n}\n\nconst addListeners = function(appendTo) {\n    let container = appendTo\n    container.addEventListener('click', (e) => {\n        console.log(e.target.parentElement.id)\n        console.log(e.target)\n        console.log(e.target.dataset.x)\n        console.log(e.target.dataset.y)\n    })\n} \n\nconst userSetupShip = function(gameBoard, direction){\n    for (let i = 0; i < 5; i++){\n\n        let shipSet = gameBoard.setShip(i, x, y, direction)\n        while (shipSet === false) {\n            alert('this ship can not be place here, please try again')\n            shipSet = gameBoard.setShip(i, x, y, direction)\n        }\n    }\n}\n\nconst initUI = function(){\n\n    let leftBoard = boardUI('left', 'left-player-board')\n    let rightBoard = boardUI('right', 'right-player-board')\n\n    addListeners(leftBoard)\n    addListeners(rightBoard)\n}\n\n\nconst initGameLogic = function(){\n    playerBoard = (0,_factories_boardFactory_js__WEBPACK_IMPORTED_MODULE_1__.Gameboard)();\n    computerBoard = (0,_factories_boardFactory_js__WEBPACK_IMPORTED_MODULE_1__.Gameboard)();\n    player = (0,_factories_playerFactory_js__WEBPACK_IMPORTED_MODULE_2__.Player)()\n    computer = (0,_factories_playerFactory_js__WEBPACK_IMPORTED_MODULE_2__.Player)()\n}\n\n\nlet playerBoard;\nlet computerBoard;\nlet player;\nlet computer;\n\ninitUI()\ninitGameLogic()\n\n\n\n//# sourceURL=webpack://battleship/./src/index.js?");
